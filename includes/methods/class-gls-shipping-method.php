			...
			public function init_form_fields()
			{
				$this->form_fields = array(
					...
					'sender_identity_card_number' => array(
						'title' => __('Sender Identity Card Number', 'gls-shipping-for-woocommerce'),
						'type' => 'text',
					...
					'content' => array(
						...
						'type' => 'text',
						'description' => __('Parcel info printed on label.', 'gls-shipping-for-woocommerce'),
						'default' => '',
						'desc_tip' => true,
					),
					...
					'type_of_printer' => array(
						...
						'desc_tip'    => true,
						'options'     => array(
							'A4_2x2'  => __('A4_2x2', 'gls-shipping-for-woocommerce'),
							'A4_4x1'  => __('A4_4x1', 'gls-shipping-for-woocommerce'),
							'Connect' => __('Connect', 'gls-shipping-for-woocommerce'),
							'Thermo'  => __('Thermo', 'gls-shipping-for-woocommerce'),
						),
					),
					'sub_section' => array(
